...
description: "Вот вариант **от первого лица**, объём около 100 слов:

В этом тексте я объясняю, зачем в научных и популярно-научных публикациях необходимо указывать паспорт фольклорной записи. Я рассматриваю паспорт как ключ к точной идентификации материала, позволяющий понять, где, когда и кем была сделана запись, а также кто является её исполнителем. Я подчёркиваю важность указания хотя бы минимального набора данных: места и даты фиксации, имени записавшего, названия фрагмента и сведений об информанте. При возможности я рекомендую дополнять паспорт биографическими и архивными данными. Такой подход обеспечивает научную корректность, воспроизводимость исследований и уважение к носителям традиции."
